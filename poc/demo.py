...
theoryNat = fplutil.get_file_content("theories/ArithmeticsNat.fpl")
...
theorySet = fplutil.get_file_content("theories/Set.fpl")
...
theoryAlgebra = fplutil.get_file_content("theories/Algebra.fpl")
...
theoryGeometry = fplutil.get_file_content("theories/Geometry.fpl")
...
theoryLinalg = fplutil.get_file_content("theories/Linalg.fpl")
...
theoryComStruct = fplutil.get_file_content("theories/CommonsStructures.fpl")
...
theoryExample25 = fplutil.get_file_content("theories/Example4-7.fpl")
