...
class SymbolTableTests(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        "uc_class_with_pred_property_one",
        "uc_class_with_pred_property_two",
        "uc_class_with_class_instance_property_one",
        "uc_class_with_class_instance_property_two",
        "uc_functional_term_with_class_instance_property_one",
        "uc_functional_term_with_class_instance_property_two",
        "uc_functional_term_with_pred_property_one",
        "uc_functional_term_with_pred_property_two",
        "uc_functional_term_with_functional_term_property_one",
        "uc_functional_term_with_functional_term_property_two",
