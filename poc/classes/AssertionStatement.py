...
class AssertionStatement(AuxInterpretation):

    def __init__(self, parse_list: list, parsing_info: AuxInterpretation):
        super().__init__(parsing_info.get_ast_info(), parsing_info.get_errors())
        self.info = parsing_info
        self.predicate = AuxPredicate(AuxSymbolTable.statement_assert)
        self.predicate.assert_predicate()
        self.outline = AuxSymbolTable.statement
