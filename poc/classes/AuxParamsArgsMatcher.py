...
class AuxParamsArgsMatcher:
    ...
    def are_types_compatible(type_arg, type_param):
        ...
        if type_param.id == type_arg.id:
            ...
            # even though there is was no match of IDs, we could so far ensure the consistency of types.
            # in this case, we still to check if the two consistent types with different IDs are still compatible,
