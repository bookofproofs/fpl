...
class OutputLines(list):
            ...
            if i >= len(rule_def):
                ...
                for chunk in split:
                    ...
                    if rule_name in ["NamespaceIdentifier", "WildcardTheoryNamespace", "WildcardTheoryNamespaceList",
                                     ...
                                     "PrimePredicate", "Identifier", "LocalizationList", "VariableDeclarationList",
                                     "AnonymousDeclaration", "VariableList", "VariableSpecificationList",
    ...
    def add_conflicts(self):
        ...
        self.append_line("[$.VariableDeclarationList],")
        self.append_line("[$.AnonymousDeclaration, $.AnonymousSignature],")
        ...
        self.append_line("[$.VariableType, $.AnonymousSignature],")
        ...
        self.append_line("[$.ReferencedResultIdentifier, $.Signature],")
