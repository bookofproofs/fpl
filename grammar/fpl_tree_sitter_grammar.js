...
module.exports = grammar({
  ...
  conflicts: $ => [
    ...
    [$.AnonymousDeclaration, $.AnonymousSignature],
    [$.VariableList],
    [$.VariableList, $.Entity],
    ...
    [$.CoordList],
    [$.RangeInSignature],
    [$.VariableType, $.AnonymousSignature],
    [$.Type, $.Identifier],
    [$.Property],
    ...
    [$.ReferencedResultIdentifier, $.Signature],
    [$.Justification],
  ...
  rules: {
    ...
    Mapping: $ => seq($.To, optional($.IW), $.TypeOrTupleOfTypes), 
    ...
    assert: $ => "assert", 
    VariableDeclaration: $ => choice($.AnonymousDeclaration, $.NamedVariableDeclaration), 
    AnonymousDeclaration: $ => choice($.AnonymousSignature, $.GeneralType), 
    NamedVariableDeclaration: $ => seq($.VariableList, optional($.IW), $.Colon, optional($.IW), $.VariableType), 
    VariableType: $ => choice($.AnonymousSignature, $.GeneralType), 
    ...
    TypeOrTupleOfTypes: $ => choice($.TupleOfTypes, $.VariableType), 
    TupleOfTypes: $ => seq($.LeftParen, optional($.IW), $.GeneralType, repeat(seq(optional($.IW), $.Comma, optional($.IW), $.GeneralType)), $.RightParen), 
    ...
    AnonymousSignature: $ => seq($.GeneralType, optional($.IW), $.ParamTuple), 
    ParamTuple: $ => seq($.LeftParen, optional($.IW), optional($.ParamList), optional($.IW), $.RightParen), 
    ParamList: $ => choice(seq($.Slash, $.ArgumentIdentifier, optional($.IW), $.Comma, optional($.IW), $.Slash, $.ArgumentIdentifier), $.VariableDeclarationList), 
    VariableDeclarationList: $ => seq($.VariableDeclaration, repeat(seq(optional($.IW), $.Comma, optional($.IW), $.VariableDeclaration))), 
    ...
    CoordInSignature: $ => choice($.VariableType, $.Coord), 
    ...
    ProofArgument: $ => seq($.ArgumentIdentifier, $.Dot, optional($.IW), optional(seq($.Justification, $.SW)), $.ArgumentInference), 
    VDash: $ => "|-", 
    ...
    qed: $ => "qed", 
    trivial: $ => "trivial", 
    PremiseOrOtherPredicate: $ => choice($.PremiseHeader, $.DerivedPredicate), 
    ArgumentInference: $ => choice($.AssumedPredicate, $.DerivedPredicate, $.Revoke), 
    Revoke: $ => seq($.RevokeHeader, $.SW, $.Slash, $.ArgumentIdentifier), 
    RevokeHeader: $ => choice($.revoke, $.rev), 
    Justification: $ => seq($.Slash, $.ReferencedResultIdentifier, repeat(seq(optional($.IW), $.Comma, optional($.IW), $.Slash, $.ReferencedResultIdentifier))), 
    Slash: $ => "/", 
    ReferencedResultIdentifier: $ => choice($.ArgumentIdentifier, $.Signature, $.PredicateIdentifier), 
    proof: $ => "proof", 
    prf: $ => "prf", 
    assume: $ => "assume", 
    ass: $ => "ass", 
    ...
    PrimePredicate: $ => choice($.PredicateWithArguments, $.QualifiedIdentifier, $.Statement, $.Identifier, $.IsOperator, $.true, $.false, $.UndefinedHeader), 
    ...
    Alias: $ => seq($.IW, $.alias, $.IW, $.IdStartsWithCap), 
    alias: $ => "alias", 
