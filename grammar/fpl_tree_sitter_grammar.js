...
module.exports = grammar({
  ...
  rules: {
    ...
    PredicateDefinitionBlock: $ => seq($.LeftBrace, repeat($.CW), optional($.VariableSpecificationList), repeat($.CW), optional($.Predicate), repeat($.CW), optional($.PropertyList), repeat($.CW), $.RightBrace), 
    PredicateInstanceBlock: $ => seq($.LeftBrace, repeat($.CW), optional($.VariableSpecificationList), repeat($.CW), $.Predicate, repeat($.CW), $.RightBrace), 
    ...
    DefinitionProperty: $ => choice($.PredicateInstance, $.FunctionalTermInstance, $.ClassInstance), 
    ClassInstance: $ => seq($.VariableType, $.SW, $.Signature, repeat($.CW), $.InstanceBlock), 
    FunctionalTermInstance: $ => seq($.FunctionalTermSignature, repeat($.CW), $.InstanceBlock), 
    PredicateInstance: $ => seq($.PredicateHeader, $.SW, $.Signature, repeat($.CW), $.PredicateInstanceBlock), 
    ...
    At: $ => "@", 
    TheoremLikeStatementOrConjecture: $ => seq($.TheoremLikeStatementOrConjectureHeader, $.SW, choice($.CorollarySignature, $.Signatur), optional($.IW), $.PremiseConclusionBlock), 
    TheoremLikeStatementOrConjectureHeader: $ => choice($.theorem, $.thm, $.conjecture, $.conj, $.proposition, $.prop, $.lemma, $.lem, $.CorollaryHeader), 
    CorollarySignature: $ => seq($.ReferencingIdentifier, optional($.IW), $.ParamTuple), 
    CorollaryHeader: $ => choice($.corollary, $.cor), 
    theorem: $ => "theorem", 
    thm: $ => "thm", 
    ...
    conj: $ => "conj", 
    Proof: $ => seq($.ProofHeader, $.SW, $.ReferencingIdentifier, optional($.IW), $.ProofBlock), 
    ReferencingIdentifier: $ => seq($.PredicateIdentifier, $.DollarDigitList), 
    DollarDigitList: $ => seq($.Dollar, $.Digit, repeat(seq($.Dollar, $.Digit))), 
    ProofHeader: $ => choice($.proof, $.prf), 
    ...
    Identifier: $ => choice($.PredicateIdentifier, $.IndexValue, $.Assignee), 
    IndexValue: $ => seq($.KeysOfVariadicVariable, choice($.Digit, $.Variable)), 
    self: $ => "self", 
    ...
    IsOperator: $ => seq($.is, optional($.IW), $.LeftParen, repeat($.CW), $.Identifier, repeat($.CW), $.Comma, optional($.IW), $.GeneralType, optional($.IW), $.RightParen), 
    ...
    Dollar: $ => "$", 
    PythonDelegate: $ => seq($.py, $.Dot, $.PythonIdentifier, optional($.IW), $.LeftParen, optional($.IW), $.PredicateList, optional($.IW), $.RightParen), 
    ...
    RangeOrLoopBody: $ => seq($.Assignee, $.SW, $.VariableRange, repeat($.CW), $.LeftParen, repeat($.CW), $.StatementList, repeat($.CW), $.RightParen), 
    VariableRange: $ => seq($.KeysOfVariadicVariable, $.|, $.ClosedOrOpenRange, $.|, $.Assignee), 
